...
class EntropyCalibrator(trt.Ifp16EntropyCalibrator2):
    def __init__(self, training_data, cache_file, batch_size=16):
        # Whenever you specify a custom constructor for a TensorRT class,
        # you MUST call the constructor of the parent explicitly.
        trt.Ifp16EntropyCalibrator2.__init__(self)
...
def build_fp16_engine(onnx_file_path, calib, batch_size, verbose=False):
...
def main():
    ...
    parser.add_argument(
        '-m', '--model', type=str, default='F_Let.onnx',
        )
    args = parser.parse_args() 

    calibration_cache = "calibration.cache"  
    data_path = '/home/semi/Downloads/Mnist/mnist_data_jpg/mnist_test_jpg_10000/'
    ...
    engine =  build_fp16_engine(onnx_file_path, calib, 1)
